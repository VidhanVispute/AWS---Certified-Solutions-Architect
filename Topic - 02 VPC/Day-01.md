...
This topic covered the **why** and the **what** of VPC — the isolation problem it solves, how it fits in the AWS hierarchy, and the difference between Default and Custom VPCs. 

The next topics will build the actual VPC architecture layer by layer:
- **Subnets** — carving your VPC CIDR into public and private segments, AZ mapping
- **Internet Gateway** — how public-facing resources get internet access
- **Route Tables** — how traffic decisions are made within and outside the VPC
- **NAT Gateway / NAT Instance** — how private resources reach the internet without being reachable from it
- **NACLs vs Security Groups** — stateless vs stateful, layered defense
- **VPC Peering and Transit Gateway** — connecting VPCs together

Drop the next topic whenever you're ready.
